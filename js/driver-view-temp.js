...
document.getElementById("driver-id-input").addEventListener("input", function () {
...
document.getElementById("driver-search-btn").addEventListener("click", function () {
  triggerDriverSearch();
});

document.getElementById("driver-id-input").addEventListener("keydown", function (e) {
